...
static const BCScriptSigHashCode SIGHASH_ALL = 0x00000001;
static const BCScriptSigHashCode SIGHASH_NONE = 0x00000002;
static const BCScriptSigHashCode SIGHASH_SINGLE = 0x00000003;
static const BCScriptSigHashCode SIGHASH_ANYONECANPAY = 0x00000080;
...
static NSString *stingFromSigHashCode(BCScriptSigHashCode sigHashCode) {
  switch (sigHashCode) {
    case SIGHASH_ALL:
      return @"SIGHASH_ALL";
      break;

...
- (void)testHDVector1 {
  @try {
    ...
    XCTAssert([kp isKindOfClass:[BCKeySequence class]], @"Failed");
    ...
    XCTAssert([h0 isKindOfClass:[BCKeyPair class]], @"Failed");
    ...
    XCTAssert([h0.chainCode
                  isEqualToData:@"47fdacbd0f1097043b78c63c20c34ef4ed9a111d980"
                                @"047ad16282c7ae6236141".hexToData],
              @"Failed");

    // Validate the h0 public key is correct
    XCTAssert([h0.publicKey
                  isEqualToData:@"035a784662a4a20a65bf6aab9ae98a6c068a81c52e4"
    ...
    XCTAssert([externalChain isKindOfClass:[BCKeyPair class]], @"Failed");
    ...
    XCTAssert([exh2 isKindOfClass:[BCKeyPair class]], @"Failed");
    ...
    // Check Chain Code
    XCTAssert([exh2.chainCode
                  isEqualToData:@"04466b9cc8e161e966409ca52986c584f07e9dc81"
                                @"f735db683c3ff6ec7b1503f".hexToData],
              @"Failed");

    // Check Public Key
    XCTAssert([exh2.publicKey
                  isEqualToData:@"0357bfe1e341d01c69fe5654309956cbea516822f"
    ...
    XCTAssert([exh2_2 isKindOfClass:[BCKeyPair class]], @"Failed");
    ...
    // Check Chain Code
    XCTAssert([exh2_2.chainCode
                  isEqualToData:@"cfb71883f01676f587d023cc53a35bc7f88f724"
...
- (void)testHDVector2 {
  @try {
    ...
    XCTAssert([m_0 isKindOfClass:[BCKeyPair class]], @"Failed");

    // Check That the master chain code is correct
    XCTAssert([m_0.chainCode
                  isEqualToData:@"f0909affaa7ee7abe5dd4e100598d4dc53cd709d5a"
                                @"5c2cac40e7412f232f7c9c".hexToData],
              @"Failed.");

    // Check that the private key is correct.
    XCTAssert(
        [[m_0 privateKeyUsingMemoryKey:pass]
            isEqualToData:@"abe74a98f6c7eabee0428f53798f0ab8aa1bd3787399904"
                          @"1703c742f15ac7e1e".hexToData],
        @"Failed.");

    // Check That the master public key is correct
    XCTAssert([m_0.publicKey
                  isEqualToData:@"02fc9e5af0ac8d9b3cecfe2a888e2117ba3d089d85"
    ...
    XCTAssert([m_0_2147483647H isKindOfClass:[BCKeyPair class]], @"Failed");

    // Check That the master chain code is correct
    XCTAssert(
        [m_0_2147483647H.chainCode
    ...
    // Check that the private key is correct.
    XCTAssert(
        [[m_0_2147483647H privateKeyUsingMemoryKey:pass]
    ...
    XCTAssert([m_0_2147483647H_1 isKindOfClass:[BCKeyPair class]], @"Failed");

    // Check That the master chain code is correct
    XCTAssert(
        [m_0_2147483647H_1.chainCode
    ...
    // Check that the private key is correct.
    XCTAssert(
        [[m_0_2147483647H_1 privateKeyUsingMemoryKey:pass]
    ...
    m_0_2147483647H_1_2147483646 =
        [m_0_2147483647H_1 childKeyPairAt:0x80000000 | 2147483646
                            withMemoryKey:pass];
    XCTAssert([m_0_2147483647H_1_2147483646 isKindOfClass:[BCKeyPair class]],
              @"Failed");

    // Check That the master chain code is correct
    XCTAssert(
        [m_0_2147483647H_1_2147483646.chainCode
    ...
    // Check that the private key is correct.
    XCTAssert(
        [[m_0_2147483647H_1_2147483646 privateKeyUsingMemoryKey:pass]
    ...
    // Check That the master public key is correct
    XCTAssert(
        [m_0_2147483647H_1_2147483646.publicKey
    ...
    XCTAssert([m_0_2147483647H_1_2147483646_2 isKindOfClass:[BCKeyPair class]],
              @"Failed");

    // Check That the master chain code is correct
    XCTAssert(
        [m_0_2147483647H_1_2147483646_2.chainCode
    ...
    // Check that the private key is correct.
    XCTAssert(
        [[m_0_2147483647H_1_2147483646_2 privateKeyUsingMemoryKey:pass]
    ...
    // Check That the master public key is correct
    XCTAssert(
        [m_0_2147483647H_1_2147483646_2.publicKey
